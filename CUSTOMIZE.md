# Customization checklist — Face Quest
...
- [ ] `etsy-package/tools/generate-video.mjs` — ffmpeg-based generator
   ...
   `Face Quest` / `Learn • Spot • Play` substitutions don't fit your design.
...
- [ ] (Optional) `gh api -X POST "repos/abourdim/face-quest/pages" -f 'source[branch]=main' -f 'source[path]=/'` — enable GitHub Pages so the live demo URL in the listing actually works
