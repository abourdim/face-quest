...
const I18N = {
  en: { tagline: 'See the live demo in 30s.', role: 'face-quest · author', contactLabel: 'Say hi' },
  fr: { tagline: 'Chaque capteur, en direct dans le navigateur.', role: 'auteur · face-quest', contactLabel: 'Contact' },
  ar: { tagline: 'كل حساس، مباشرةً في المتصفح.', role: 'مؤلف · face-quest', contactLabel: 'للتواصل' },
};
const T = I18N[LANG];
