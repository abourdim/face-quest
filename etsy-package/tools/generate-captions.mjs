...
TEMPLATES_BY_LANG.ar = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `رسم face-api.js · نماذج Three.js · مصدر makecode.ts مُرفق`,
...
TEMPLATES_BY_LANG.fr = {
  ...
  kid: {
    ...
    subtitles: [
      `Capteurs, face scans, fonctionnalités. Sans install. Sans compte.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Graphique face-api.js · modèles Three.js · source makecode.ts inclus`,
...
TEMPLATES_BY_LANG.en = {
  teacher: {
    ...
    socialCaptions: [
      ...
      `One Etsy download. Zero IT tickets. Thirty students graphing real face tracker data.`,
    ],
    pinCaptions: [
  ...
  kid: {
    ...
    subtitles: [
      `Sensors, face scans, 3D models. No install. No account.`,
      `Works offline after the first open.`,
      `Draw on the LEDs. Hear the buzzer. Tilt the 3D model.`,
      `3 modes of things to try. Your parents won't understand most of them.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `face-api.js graph · Three.js models · makecode.ts source included`,
