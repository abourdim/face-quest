...
RULES_BY_LANG.ar = [
  ...
  { id: 'face scans-motors', keywords: ['face scan', 'محرك', 'تحريك'],
    answer: `${PRODUCT} يقود محركَي face scan متصلَين بالمنفذَين P1 وP2. علامة تبويب المحركات بها منزلقات، علامة تبويب لوحة اللعب ترسل أوامر اتجاهية.` },
];
...
RULES_BY_LANG.fr = [
  ...
  { id: 'face scans-motors', keywords: ['face scan', 'moteur', 'bouger'],
    answer: `${PRODUCT} pilote deux face scans connectés aux broches P1 et P2. L'onglet Moteurs a des curseurs, l'onglet Manette envoie des commandes directionnelles.` },
];
...
RULES_BY_LANG.en = [
  ...
  },
  {
    ...
    answer: `The Quest Log records live sensor data and exports CSV — one row per sample, ready for Excel / Sheets / Python. You can also load back a saved CSV and replay it.`,
  },
  {
    id: 'face scans-motors',
    keywords: ['face scan', 'motor', 'move', 'physical'],
    answer: `${PRODUCT} drives two face scans connected to pins P1 and P2. The Motors tab has sliders for angle control, the Voice Commands tab sends directional commands, and the 3D tab mirrors the board's orientation in real time.`,
  },
];
