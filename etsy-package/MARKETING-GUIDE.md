# Marketing Asset Guide — Face Quest
...
| `output/en/screenshots/screenshot-sensors-annotated.png` | Camera panel with "Live from micro:bit" call-out. |
...
| `graph-record.gif` | Quest Log with Simulate running — live waveform | Etsy listing slot (secondary) · YouTube community post |
...
| `classroom-poster.html` | A3 poster for classroom wall. "We Teach Computers to See Us" + 5 steps. |
...
**Where:** Paste into `face-quest/index.html` or the hosted live-demo
page (`abourdim.github.io/face-quest`). Nothing else to do.
...
Output: `output/shared/buyers/FaceQuest-AS-12345-v1.2.0.zip`
...
**Where:**
- Own GitHub repo like `github.com/abourdim/face-quest-companion`
- Listed in the Etsy description: "MakeCode extension published — search face-quest-companion"
...
| URL | What buyer sees |
|---|---|
| `#tab=graph` | Quest Log, ready to Simulate |
| `#main` | Product demo screen |
| `#tab=senses&lang=fr` | Camera panel in French |

**Where:**
- Etsy description: "→ See the live 3D tab: abourdim.github.io/face-quest/#tab=board3d"
