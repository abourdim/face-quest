...
> 🧪 **Live demo**: <https://abourdim.github.io/face-quest/>
...
- [ ] **Record the 60-second listing video** following
      ...
      with videos by ~30%.
- [ ] **Create the QUESTLAUNCH Etsy promo code** (Shop Manager → Marketing
      → Sales & coupons → new code `QUESTLAUNCH`, $8 discount off $14.99,
...
- [ ] **Shoot a real micro:bit photo** for the hero. Current hero
      ...
      Face Quest scanner with a clear MATCH ✅ verdict. Good light,
      plain background, crop square.
...
- [ ] Final sanity check: does the description's "what you get" list
      exactly match what `FaceQuest-v1.0.0.zip` actually contains?
...
- [x] ~~Host a live demo on GitHub Pages~~ — done. Live at
      <https://abourdim.github.io/face-quest/>. Already in the
      listing description.
...
- [ ] **Create the QUESTLAUNCH promo code** (first 10 buyers: $14.99 → $8
