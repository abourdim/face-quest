...
All Etsy-release assets for **Face Quest**: the ZIP builder, the
...
Produces `etsy-package/FaceQuest-v1.0.0.zip` with the app
...
├── FaceQuest-v1.0.0/         📦 Build staging dir
├── FaceQuest-v1.0.0.zip      📦 Final buyer ZIP
│
