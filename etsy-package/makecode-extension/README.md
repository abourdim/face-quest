...
[face-quest browser app](https://abourdim.github.io/face-quest/) —
...
2. **Advanced → Extensions → search** `abourdim/face-quest-companion`
...
That's it. Sensor stream starts, LEDs / face scans / buzzer all respond.
...
declares it, `main.ts` is the example, `face-quest.ts` is the block
